...
4. Open the deployed URL on desktop and mobile, then verify the zoomable basemap, H3 overlay, overlay-opacity slider, mode toggles, layer toggles, hex click panel, clickable recommendation shortlist, recommender sliders, and data transparency section.
